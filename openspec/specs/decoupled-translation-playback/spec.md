# decoupled-translation-playback Specification

## Purpose

Keep translated browser text responsive while bounding Spanish audio playback
backlog so that slow speech output cannot create cumulative translation delay.
