...
- **THEN** the command SHALL remain active, continuously capture microphone audio, use 4-second windows beginning every 3 seconds, and print completed transcript text for successive Whisper windows
